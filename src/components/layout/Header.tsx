  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        <nav className="hidden xl:flex items-center gap-3.5 2xl:gap-5 flex-shrink">
          {navLinks.map((link) => (
            <a
              key={link.label}
              href={link.href}
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-[#E6CA85] to-[#C5A059] hover:from-[#C5A059] hover:to-[#b08b43] text-[#08090A] font-sans font-bold text-[10.5px] sm:text-xs tracking-[0.15em] uppercase px-4 sm:px-6 py-2.5 rounded-full transition-all duration-300 transform hover:scale-105 shadow-[0_4px_20px_rgba(197,160,89,0.35)] cursor-pointer whitespace-nowrap flex-shrink-0"
          >
          ...
          <button
            ...
            className="xl:hidden p-2 rounded-full glass-obsidian hover:bg-white/20 text-white transition-colors cursor-pointer border border-white/15 shrink-0"
          >
